...
class ClassificationParser(BaseParser):
    """
    A parser for the classification dataset.
    """
    ...
    def download_dataset(self):
        ...
        if os.path.exists(cache_dir):
            ...
            ag_news_dirs = [d for d in cache_contents if "ag_news" in d or "sh0416" in d]
            if ag_news_dirs:
                print(f"Found ag_news cache directories: {ag_news_dirs}")
        else:
        ...
        try:
            ...
            if "Network" in error_str or "unreachable" in error_str or "Connection" in error_str:
                ...
                try:
                    ...
                    cache_pattern = os.path.join(cache_dir, "*", "*ag_news*", "*")
